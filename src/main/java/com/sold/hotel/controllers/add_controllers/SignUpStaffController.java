...
public class SignUpStaffController implements Initializable {
    @FXML
    TextField loginTF;
    @FXML
    ...
    public void acceptAction() {
        try {
            if (connection != null) {
                ...
                if (!Validate.isPost(post)) {
                    Utils.alertBox("Post entered incorrectly", null, "Error");
                    return;
                }
